...
[source,php]
----
$connectionPool = 'Goodses\Elasticsearch\ConnectionPool\StaticNoPingConnectionPool';
$client = ClientBuilder::create()
...
[source,php]
----
$selector = 'Goodses\Elasticsearch\ConnectionPool\Selectors\StickyRoundRobinSelector';
$client = ClientBuilder::create()
...
[source,php]
----
$serializer = 'Goodses\Elasticsearch\Serializers\SmartSerializer';
$client = ClientBuilder::create()
