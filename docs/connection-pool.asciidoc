...
$client = ClientBuilder::create()
            ->setConnectionPool('Goodses\Elasticsearch\ConnectionPool\StaticNoPingConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('Goodses\Elasticsearch\ConnectionPool\SimpleConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('Goodses\Elasticsearch\ConnectionPool\SniffingConnectionPool', [])
            ->build();
----
