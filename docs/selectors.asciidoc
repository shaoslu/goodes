...
$client = ClientBuilder::create()
            ->setSelector('Goodses\Elasticsearch\ConnectionPool\Selectors\RoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('Goodses\Elasticsearch\ConnectionPool\Selectors\StickyRoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('Goodses\Elasticsearch\ConnectionPool\Selectors\RandomSelector')
            ->build();
----
